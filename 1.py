...
TOKEN = os.environ.get('MTE2NzQxMzg1MTMwMjY3ODU0MQ.GosDyD.4D8Hl6Jqjz1g6Y8yHCn9BKqc1sJDalcssWxEG8')
...
async def verifier_roles(user):
    ...
    # Vérifie les seuils d'XP pour attribuer des rôles
    if xp >= 1000:
...
bot.run('MTE2NzQxMzg1MTMwMjY3ODU0MQ.GosDyD.4D8Hl6Jqjz1g6Y8yHCn9BKqc1sJDalcssWxEG8')
